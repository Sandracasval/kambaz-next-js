...
export default function Signin() {
  ...
  //clicking the signin button posts the credentials to the server using the
  //client.signin function
  //when the server responds succesfully, the currently logged in user is stored in the
  //user recucer and navigate to the Profile screen implented in a later section
  const signin = async () => {
