...
//pathname is used to check if the url ends with /Lab1 /Lab2 or /Lab3
//pathname also enables dynamic UI logic such as higlighting navigation elements
//or conditionally rendering the content
export default function TOC() {
  ...
  return (
    <Nav variant="pills">
      ...
      <NavItem>
        <NavLink href="https://github.com/Sandracasval">My GitHub</NavLink>
      </NavItem>
    </Nav>
  );
}
